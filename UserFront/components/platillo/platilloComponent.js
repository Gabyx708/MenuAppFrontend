export default function platilloComponente(platilloData){
    ...
    let colorBadge = "#DAD6DC"
    let descripcionCategoria = "sin categoria"

    if(platilloData.categoria.descripcion != null){
         colorBadge = platilloData.categoria.color;
         descripcionCategoria = platilloData.categoria.descripcion;
    }
    ...
    <div class="platillo-body" idMenuPlatillo=${platilloData.idMenuPlato}>
        ...
        <div class=categoria-container style="background-color:${colorBadge}">
        <h6>${descripcionCategoria}</h6>
        </div>
